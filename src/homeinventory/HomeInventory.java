...
public class HomeInventory extends JFrame{
    JToolBar tbInventory = new JToolBar();
    ...
    public HomeInventory() {
        ...
        getContentPane().add(tbInventory, gridConstraints);
        ...
        tbInventory.add(previousButton);
        ...
        dateDateChooser.setCalendar(Calendar.getInstance());
        ...
        setBounds((int) (0.5 * (screen.width - getWidth())), (int) (0.5 * (screen.height -
        ...
        try
        {
            ...
            //JOptionPane.showConfirmDialog(getContentPane(), numberEntries+"");
        if (numberEntries != 0)
            {
...
//            }
        ...
        {
            JOptionPane.showConfirmDialog(getContentPane(), "Exception" + ex);
            numberEntries = 0;
            currentEntry = 0;
        }
        if (numberEntries == 0)
    ...
    private void exitForm(WindowEvent e) {
        if (JOptionPane.showConfirmDialog(null, "Any unsaved changes will be lost.\nAre you sure you want to exit?"
                ,"Exit Program", JOptionPane.YES_NO_OPTION,
                    JOptionPane.QUESTION_MESSAGE) == JOptionPane.NO_OPTION) {
            //JOptionPane.showConfirmDialog(null, "Going to return");
            return;
        }
        ...
        try
        {
            ...
            try {
                outputFile = new PrintWriter(new BufferedWriter(new
...
class InventoryDocument implements Printable {
    public int print(Graphics g, PageFormat pf, int pageIndex) {
        ...
        for (i = 0 + HomeInventory.entriesPerPage * pageIndex; i < iEnd; i++) {
            ...
            y += dy;
            if (HomeInventory.myInventory[i].marked == true)
